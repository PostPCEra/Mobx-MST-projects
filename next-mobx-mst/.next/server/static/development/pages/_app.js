...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_4___default.a {
  static async getInitialProps({
    ...
    //
    const isServer = true;
    const store = Object(_stores_store__WEBPACK_IMPORTED_MODULE_5__["initializeStore"])(isServer); //
  ...
  constructor(props) {
    super(props);
    this.store = Object(_stores_store__WEBPACK_IMPORTED_MODULE_5__["initializeStore"])(props.isServer, props.initialState);
  }
...
function initializeStore(isServer, snapshot = null) {
  if (isServer) {
    store = Store.create({
